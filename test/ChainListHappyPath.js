...
contract('ChainList', function(accounts) {
  ...
  var buyerBalanceBeforeByu, buyerBalanceAfterBuy;
  ...
  it("should buy an article", function() {
    return ChainList.deployed().then(function(instance) {
      ...
      // check the effet of the buy on the balances of buyer and seller, accounting for gas
      ...
      assert.equal(data[0].toNumber(), 2, "article 2 shuold be the only article left for sale");
